...
export const FEATURES = [
  {
    ...
    description: "CashCam uses AI-powered market research to analyse real-world pricing data and give you accurate sell estimates instantly.",
  ...
  },
  {
    ...
    description: "Gemini vision analyses your photos to generate SEO-optimised titles and engaging descriptions automatically. Cut your listing time by 90% and banish the \"death pile\" forever.",
