...
export const ThreeQuestionMarks = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => (
    ...
    >
        <g transform="translate(12, 12) scale(0.75) translate(-12, -12)">
            ...
            {/* Left Question Mark - Moved in slightly to prevent clipping */}
            <g transform="translate(-6.5, 3) rotate(-25, 6, 12) scale(0.85)">
            ...
            {/* Right Question Mark - Moved in slightly to prevent clipping */}
            <g transform="translate(7, 2) rotate(25, 18, 12) scale(0.95)">
